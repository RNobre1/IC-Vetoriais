...
Em workstation de 16 GiB RAM + 10c/16t (ver `docs/metodologia.md` → Hardware), com 3 SGBDs já carregados em paralelo, +400 MB de Verba pode mover p99 de latência em ordem de 5-15% — ruído suficiente pra contaminar comparações.
